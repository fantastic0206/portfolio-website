...
export const projectsData = [
    ...
    {
        id: 3,
        name: 'Door TM Browser',
        description: [
            "- Developed interactive front-end components and optimized APIs, increasing user engagement by 40% and data retrieval efficiency.",
            "- Migrated legacy systems to MongoDB and Firebase, improving data access speed by 30% for over 1 million users.",
            "- Achieved a 95% customer satisfaction rate and earned management recognition for service excellence.",
            "- Created dynamic, data-driven web applications using PHP, implementing server-side logic to manage user authentication, data validation, and session handling, which improved data security and enhanced the user experience.",
        ...
        tools: ['Front-End Development', 'API Development', 'MongoDB', 'Firebase', 'PHP', 'WordPress', 'MySQL'],
        code: '',
